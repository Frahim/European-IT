...
<html <?php language_attributes(); ?>
    ...
    <body id="top" <?php
    body_class($custom_body_classes . ' ' . $mfp_alt_text . ' ' . $rtl_support . $style . ' ' . $avia_config['font_stack'] . ' ' . $blank . ' ' . $sidebar_styling);
    ...
    ?>>
        ...
        <div id='wrap_all'>
            ...
            <div id='main' class='all_colors'
                 data-scroll-offset='<?php echo avia_header_setting('header_scroll_offset'); ?>'>
